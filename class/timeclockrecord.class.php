...
class TimeclockRecord extends CommonObject
{
     ...
     */
    // REMOVED: clockIn() method moved to TimeclockService for better architecture (SRP)
    // Use TimeclockService::clockIn() instead

    // REMOVED: clockOut() method moved to TimeclockService for better architecture (SRP)
    // Use TimeclockService::clockOut() instead

    // REMOVED: getActiveRecord() method moved to TimeclockService for better architecture (SRP)
    // Use TimeclockService::getActiveRecord() instead

    // REMOVED: calculateWorkDuration() method moved to TimeclockService for better architecture (SRP)
    // Use TimeclockService::calculateSessionDuration() instead
    ...
    // REMOVED: getWorkSummary() method moved to DataService for better architecture (SRP)
    // Use DataService::calculateTodaySummary() or DataService::calculateWeeklySummary() instead
