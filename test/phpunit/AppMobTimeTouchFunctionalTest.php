...
/**
 * \file    test/phpunit/AppMobTimeTouchFunctionalTest.php
...
/**
 * Class AppMobTimeTouchFunctionalTest
 *
 ...
 *
 * @package Testappmobtimetouch
 */
class AppMobTimeTouchFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modAppMobTimeTouch')->click();
		} else {
			// Disable the module
			$this->byHref('modAppMobTimeTouch')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/appmobtimetouch/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('appmobtimetouch/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/appmobtimetouch/admin/about.php');
		$this->authenticate();
		return $this->assertContains('appmobtimetouch/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('appmobtimetouchwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAppMobTimeTouch_AppMobTimeTouchTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAppMobTimeTouch_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
